...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'console.command.public_alias.Pimcore\\Bundle\\SimpleBackendSearchBundle\\Command\\SearchBackendReindexCommand' => 'getSearchBackendReindexCommandService',
    ...
    protected static function get_Container_Private_ProfilerService($container)
    {
        ...
        $f->registerBus('messenger.bus.pimcore-core', ($container->services['messenger.default_bus'] ?? self::getMessenger_DefaultBusService($container)));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+DK+AQy+Dv', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->services['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('N-sdZ3g6Aw', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->services['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pqmFxVu8iq', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->services['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('pimcore.dataobject.postUpdate', [#[\Closure(name: 'App\\EventListener\\ProductUpdateListener')] fn () => ($container->privates['App\\EventListener\\ProductUpdateListener'] ?? $container->load('getProductUpdateListenerService')), 'onObjectPostUpdate'], 0);
        ...
        $instance->addListener('pimcore.dataobject.postUpdate', [#[\Closure(name: 'App\\EventListener\\ProductUpdateListener')] fn () => ($container->privates['App\\EventListener\\ProductUpdateListener'] ?? $container->load('getProductUpdateListenerService')), 'onProductPostUpdate'], 0);
    ...
    {
        $container->services['monolog.logger.http_client'] = $instance = new \Symfony\Bridge\Monolog\Logger('http_client');
    ...
    {
        return $container->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ihVZRZWZt2', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->services['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Oue6f64saa', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->services['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('j4yiyCXuQE', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->services['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UcHRcJZ7Kv', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->services['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jyKMDyDUmN', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->services['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lViavFvPnS', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->services['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getHttpClient_TransportService($container)
    {
        ...
        if ($container->has('monolog.logger.http_client')) {
            $instance->setLogger(($container->services['monolog.logger.http_client'] ?? self::getMonolog_Logger_HttpClientService($container)));
        }
    ...
    protected static function getTwig_Runtime_HttpkernelService($container)
    {
        ...
        return $container->privates['twig.runtime.httpkernel'] = new \Symfony\Bridge\Twig\Extension\HttpKernelRuntime(new \Symfony\Component\HttpKernel\DependencyInjection\LazyLoadingFragmentHandler(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'inline' => '?',
        ]), $a, true), new \Symfony\Component\HttpKernel\Fragment\FragmentUriGenerator('/_fragment', new \Symfony\Component\HttpKernel\UriSigner('98+ljcD9TtKfbwU+X2oOuTZY+UAe58ny8rYrBVGTpXY='), $a));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'locale' => 'en',
            'secret' => '98+ljcD9TtKfbwU+X2oOuTZY+UAe58ny8rYrBVGTpXY=',
            ...
            'kernel.secret' => '98+ljcD9TtKfbwU+X2oOuTZY+UAe58ny8rYrBVGTpXY=',
            ...
            'console.command.ids' => [
                0 => 'console.command.public_alias.Pimcore\\Bundle\\SimpleBackendSearchBundle\\Command\\SearchBackendReindexCommand',
                1 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Asset\\GenerateChecksumCommand',
                2 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Asset\\RemoveCustomSettingCommand',
                3 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Bundle\\ListCommand',
                4 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\CacheWarmingCommand',
                5 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\ClassesDefinitionsBuildCommand',
                6 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Definition\\Import\\ClassCommand',
                7 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Definition\\Import\\CustomLayoutCommand',
                8 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Definition\\Import\\FieldCollectionCommand',
                9 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Definition\\Import\\ObjectBrickCommand',
                10 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\DeleteClassificationStoreCommand',
                11 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\DeleteUnusedLocaleDataCommand',
                12 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Document\\CleanupCommand',
                13 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Document\\GeneratePagePreviews',
                14 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Document\\MigrateElementsCommand',
                15 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\EmailLogsCleanupCommand',
                16 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\GenerateStaticPagesCommand',
                17 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\InternalMigrationHelpersCommand',
                18 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\InternalModelDaoMappingGeneratorCommand',
                19 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\InternalUnicodeCldrLanguageTerritoryGeneratorCommand',
                20 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\LowQualityImagePreviewCommand',
                21 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\MaintenanceModeCommand',
                22 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Migrate\\StorageCommand',
                23 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Migrate\\ThumbnailsFolderStructureCommand',
                24 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\MysqlToolsCommand',
                25 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\RecyclebinCleanupCommand',
                26 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\RequirementsCheckCommand',
                27 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\ResetPasswordCommand',
                28 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\RunScriptCommand',
                29 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\ThumbnailsClearCommand',
                30 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\ThumbnailsImageCommand',
                31 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\ThumbnailsVideoCommand',
            ],
        ];
    }
}
