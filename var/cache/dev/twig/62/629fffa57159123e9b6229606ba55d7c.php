...
class __TwigTemplate_393d270a0cb331e229af5068b76273aa extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_below_footer($context, array $blocks = [])
    {
        ...
        // line 53
        echo "<script ";
        echo $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, (isset($context["pimcore_csp"]) || array_key_exists("pimcore_csp", $context) ? $context["pimcore_csp"] : (function () { throw new RuntimeError('Variable "pimcore_csp" does not exist.', 53, $this->source); })()), "getNonceHtmlAttribute", [], "method", false, false, true, 53), 53, $this->source);
        echo ">
    ";
        // line 54
    ...
    window.setInterval(refreshCsrfToken, ";
        // line 89
        echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed((isset($context["csrfTokenRefreshInterval"]) || array_key_exists("csrfTokenRefreshInterval", $context) ? $context["csrfTokenRefreshInterval"] : (function () { throw new RuntimeError('Variable "csrfTokenRefreshInterval" does not exist.', 89, $this->source); })()), 89, $this->source), "html", null, true);
        echo ");
...
";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["includeTemplates"]) || array_key_exists("includeTemplates", $context) ? $context["includeTemplates"] : (function () { throw new RuntimeError('Variable "includeTemplates" does not exist.', 103, $this->source); })()));
        $context['loop'] = [
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["includeTemplate"]) {
            // line 104
            echo "    ";
            echo twig_include($this->env, $context, $this->sandbox->ensureToStringAllowed($context["includeTemplate"], 104, $this->source));
            echo "
";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
";
    ...
    {
        return array (  283 => 107,  280 => 106,  263 => 104,  246 => 103,  229 => 89,  210 => 73,  193 => 58,  188 => 55,  186 => 54,  181 => 53,  171 => 52,  151 => 41,  138 => 31,  134 => 29,  132 => 28,  124 => 25,  118 => 22,  113 => 20,  109 => 19,  105 => 18,  102 => 17,  96 => 14,  93 => 13,  90 => 12,  84 => 9,  81 => 8,  79 => 7,  74 => 5,  71 => 4,  61 => 3,  38 => 1,);
    }
...
{% endblock %}
", "@PimcoreAdmin/admin/login/login.html.twig", "/Users/saranggangapurkar/Documents/projects/my-project/vendor/pimcore/admin-ui-classic-bundle/templates/admin/login/login.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("if" => 7, "for" => 103);
        static $filters = array("escape" => 5, "striptags" => 5, "raw" => 9, "trans" => 9);
        static $functions = array("path" => 5, "include" => 104, "pimcore_breach_attack_random_content" => 107);
