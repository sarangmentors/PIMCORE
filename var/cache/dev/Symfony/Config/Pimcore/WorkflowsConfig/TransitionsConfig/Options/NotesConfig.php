    ...
    */
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('additionalFields', $value)) {
            $this->_usedProperties['additionalFields'] = true;
            $this->additionalFields = array_map(function ($v) { return new \Symfony\Config\Pimcore\WorkflowsConfig\TransitionsConfig\Options\Notes\AdditionalFieldsConfig($v); }, $value['additionalFields']);
