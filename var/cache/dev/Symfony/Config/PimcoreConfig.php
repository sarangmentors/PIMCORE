...
class PimcoreConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
    ...
    */
    ...
    /**
     * @default {"ignore_localized_query_fallback":false,"tree_paging_limit":30,"auto_save_interval":60,"custom_layouts":{"definitions":[]},"class_definitions":{"data":{"map":[],"prefixes":[]},"layout":{"map":[],"prefixes":[]}}}
    */
    ...
    */
    ...
    /**
     * @default {"image_thumbnails":{"write_target":{"type":"symfony-config","options":{"directory":"\/Users\/saranggangapurkar\/Documents\/projects\/my-project\/var\/config\/image_thumbnails"}}},"video_thumbnails":{"write_target":{"type":"symfony-config","options":{"directory":"\/Users\/saranggangapurkar\/Documents\/projects\/my-project\/var\/config\/video_thumbnails"}}},"document_types":{"write_target":{"type":"symfony-config","options":{"directory":"\/Users\/saranggangapurkar\/Documents\/projects\/my-project\/var\/config\/document_types"}}},"predefined_properties":{"write_target":{"type":"symfony-config","options":{"directory":"\/Users\/saranggangapurkar\/Documents\/projects\/my-project\/var\/config\/predefined_properties"}}},"predefined_asset_metadata":{"write_target":{"type":"symfony-config","options":{"directory":"\/Users\/saranggangapurkar\/Documents\/projects\/my-project\/var\/config\/predefined_asset_metadata"}}},"perspectives":{"write_target":{"type":"symfony-config","options":{"directory":"\/Users\/saranggangapurkar\/Documents\/projects\/my-project\/var\/config\/perspectives"}}},"custom_views":{"write_target":{"type":"symfony-config","options":{"directory":"\/Users\/saranggangapurkar\/Documents\/projects\/my-project\/var\/config\/custom_views"}}},"object_custom_layouts":{"write_target":{"type":"symfony-config","options":{"directory":"\/Users\/saranggangapurkar\/Documents\/projects\/my-project\/var\/config\/object_custom_layouts"}}},"system_settings":{"write_target":{"type":"symfony-config","options":{"directory":"\/Users\/saranggangapurkar\/Documents\/projects\/my-project\/var\/config\/system_settings"}},"read_target":{"type":null,"options":{"directory":null}}}}
    */
